...
- ดี: "แยก Dashboard กับ payment API ว่าค้างตรงไหน"
- ดี: "ร่างข้อความตอบ ABC Corp แบบไม่ commit เวลา"
- ห้าม: "เปิดไฟล์ที่เกี่ยวข้อง", "ทำก้าวหลักนี้ทันที", "จัดการงานนี้", "เปิดบริบท"
- ห้าม: "พักหายใจ 2 นาทีแล้วกลับมาเรื่อง ABC Corp", "เช็กว่าต้องเติมอะไรที่สุด"
