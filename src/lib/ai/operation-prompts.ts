...
- ถ้า behaviorIntent = personal_friction แต่ sourceText มีบริบทงานจริง (เช่น ชื่อลูกค้า ชื่อเซิร์ฟเวอร์ เรื่อง incident):
  - อนุญาตก้าว reset/พัก ได้ไม่เกิน 1 ก้าว
  - อีก 2 ก้าวต้องอ้างอิง room anchors จริง เช่น "ตอบ ABC Corp", "เช็ก prod server"
  - ห้ามทั้ง 3 ก้าวเป็น self-care generic เช่น กิน/พัก/เติมพลัง/เริ่มงานเบาๆ
  - ตัวอย่างดี: ["พักหายใจ 2 นาที", "เปิดแชต ABC Corp ล่าสุด", "ร่างข้อความสถานะสั้นให้ลูกค้า"]
  - ตัวอย่างไม่ดี: ["เช็กว่าต้องเติมอะไร กิน/พัก", "เลือกงานเบาๆ", "ทำก้าวแรกแล้วดูพลัง"]
- รูปแบบที่ต้องคืน:
  {
    "chosenAction": {
      "title": "string",
...
- ถ้า behaviorIntent = personal_friction แต่ sourceText มีชื่อลูกค้า/ระบบ/incident:
  - อนุญาต reset/พัก ได้สูงสุด 1 ก้าว
  - อีก 2 ก้าวต้องอ้างถึง room context จริง
  - ห้ามทั้ง 3 ก้าวเป็น self-care template
