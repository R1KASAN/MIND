...
const RESCUE_NUM_PREDICT = Number(process.env.AI_NUM_PREDICT_RESCUE || 170) || 170;
const RESCUE_REPAIR_NUM_PREDICT = Number(process.env.AI_NUM_PREDICT_RESCUE_REPAIR || 210) || 210;
const RESCUE_TIMEOUT_MS = Number(process.env.AI_TIMEOUT_RESCUE_MS || 22000) || 22000;
const RESCUE_REPAIR_TIMEOUT_MS = Number(process.env.AI_TIMEOUT_RESCUE_REPAIR_MS || 12000) || 12000;
